    ...
    def init_ui(self):
        ...
        self.setStyleSheet("""
            ...
            QCheckBox::indicator:checked {
                ...
                image: url("data:image/svg+xml,%3Csvg xmlns='w3.org' viewBox='0 0 24 24' fill='none' stroke='white' stroke-width='4' stroke-linecap='round' stroke-linejoin='round'%3E%3Cpolyline points='20 6 9 17 4 12'%3E%3C/polyline%3E%3C/svg%3E");
            }
